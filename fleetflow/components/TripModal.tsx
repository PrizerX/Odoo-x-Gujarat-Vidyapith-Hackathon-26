  ...
  useEffect(() => {
    if (trip) {
      setFormData({
        ...
        start_date: typeof trip.start_date === 'string' ? trip.start_date.split('T')[0] : trip.start_date,
        end_date: trip.end_date ? (typeof trip.end_date === 'string' ? trip.end_date.split('T')[0] : trip.end_date) : '',
        status: trip.status,
        origin: trip.origin,
